...
You can also animate the properties of a layer effect by enabling the [keyframe view of the timeline](../user_manual/user_interface/timeline#keyframe-timeline).
