...
The eraser erases pixels by simply subtracting their color RGBA value by the opacity value. if the opacity value is 255 then the color RGBA value becomes (0, 0, 0 ,0), which is equivalent to black that is completely transparent.
